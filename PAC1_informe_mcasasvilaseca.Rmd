...
```{r}
load("~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/se_gcancer.Rda")
```
...
```{r}
load("~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/f_se_gcancer.Rda")
f_se_gcancer
```

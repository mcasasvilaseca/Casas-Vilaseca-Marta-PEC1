...
ruta_meatboData <- "~/Git_BiB/metaboData"
if (!dir.exists(ruta_meatboData)) {
  metaboData <- git2r::clone(url_metaboData, ruta_meatboData)
} else {
  message("El repositori ja està clonat en: ", ruta_meatboData)
}
```
...
```{r}
library(readxl)
count_gcancer <- t(read_excel("~/Git_BiB/metaboData/Datasets/2023-CIMCBTutorial/GastricCancer_NMR.xlsx"))
metabolits_metadata_gcancer <- as.data.frame(read_excel("~/Git_BiB/metaboData/Datasets/2023-CIMCBTutorial/GastricCancer_NMR.xlsx", sheet = 2))
```
...
save(se_gcancer, file = "~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/se_gcancer.Rda")
save(metabolits_metadata_gcancer, file = "~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/metabolits_metadata_gcancer.Rda")
save(sample_metadata_gcancer, file = "~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/sample_metadata_gcancer.Rda")
```
...
save(f_se_gcancer, file = "~/OneDrive - UAB/Documentos/Bioinformàtica i bioestadística/Anàlisi de dades òmiques/Repte 1. Les òmiques/R/R_objectes/f_se_gcancer.Rda")
```
